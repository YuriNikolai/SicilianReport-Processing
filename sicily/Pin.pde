class Pin {
  ...
  int y;
  PImage sample;
  String gfxfolder=sketchPath("data//gfx");//i know this is duplicated on sicily.pde and DraggingPic.pde but moving the gfxpath String outside setup to try and make it global breaks sketchPath for some reason.
